...
document.addEventListener("DOMContentLoaded", function () {
    function init() {
        ...
        // *** Modificación: Crear un arreglo de materiales para cada cara del cubo ***
        const materials = [
        ...
        // *** Modificación: Usar el arreglo de materiales al crear el Mesh ***
        ...
        const axesHelper = new THREE.AxesHelper(5); // Tamaño del eje
